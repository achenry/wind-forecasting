...
import wind_forecasting.models.spacetimeformer.spacetimeformer as stf
...
class Forecaster(L.LightningModule, ABC):
    def __init__(
        ...
        *,
        ...
        d_yc: int,
        d_yt: int,
        scaler_func: Callable[[np.ndarray], np.ndarray],
        inv_scaler_func: Callable[[np.ndarray], np.ndarray],
        ...
        self.set_scaler(scaler_func)
        self.set_inv_scaler(inv_scaler_func)
        self.save_hyperparameters()

    def set_null_value(self, val: float) -> None:
        self.null_value = val

    def set_inv_scaler(self, inv_scaler) -> None:
        self._inv_scaler = inv_scaler
