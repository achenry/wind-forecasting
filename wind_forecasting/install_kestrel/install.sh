...
conda install notebook jupyterlab nb_conda_kernels cython pyyaml matplotlib numpy seaborn netcdf4 opt_einsum wandb -c conda-forge -y
conda install wandb pytorch torchvision torchaudio torchmetrics lightning cudatoolkit -c pytorch -c nvidia -y
# pytorch-forecasting
