...
#SBATCH --time=1-00:00
#SBATCH --job-name=autoformer_train
#SBATCH --output=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/autoformer_train_%j.out
#SBATCH --error=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/autoformer_train_%j.err
...
# --- Print Job Info ---
echo "=============================================="
echo "AUTOFORMER TRAINING - H100 DDP (4 GPUs)"
echo "=============================================="
