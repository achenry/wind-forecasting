...
def main():
    ...
    config = {
        'train_data_path': '/projects/awaken/ahenry/wind_forecasting/awaken_data/awaken_processed_normalized_train_ready_15s_per_turbine_ctx14_pred7_train.pkl',
        'val_data_path': '/projects/awaken/ahenry/wind_forecasting/awaken_data/awaken_processed_normalized_train_ready_15s_per_turbine_ctx14_pred7_val.pkl',
        'context_length': 14,
        'prediction_length': 7,
        'batch_size': 32,
        'num_workers': 2,
