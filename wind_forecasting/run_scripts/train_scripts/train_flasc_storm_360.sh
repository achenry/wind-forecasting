...
#SBATCH --partition=cfdg.p          # Partition for H100/A100 GPUs cfdg.p / all_gpu.p / mpcg.p
#SBATCH --nodes=1
...
#SBATCH --job-name=flasc_train_tactis_360      # Updated job name
#SBATCH --output=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/flasc_train_tactis_360_%j.out # Updated output log path
#SBATCH --error=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/flasc_train_tactis_360_%j.err  # Updated error log path
...
srun python ${WORK_DIR}/run_scripts/run_model.py \
  ...
  --override dataset.sampler=sequential \
      ...
      experiment.run_name=train_flasc_tactis_360_storm_v2 \
      experiment.project_name=train_tactis_flasc_storm_v2 \
      logging.chkp_dir_suffix=_360_train_v2 \
      experiment.extra_tags="[\"flasc\", \"train\", \"tactis\", \"360s\", \"storm\", \"improved_copula\"]"
...
# Example usage:
# sbatch wind-forecasting/wind_forecasting/run_scripts/train_scripts/train_flasc_storm_360.sh