...
#SBATCH --gres=gpu:4
#SBATCH --time=5-00:00
#SBATCH --job-name=smoothed60_train_int
#SBATCH --output=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/smoothed60_train_int_%j.out
#SBATCH --error=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/smoothed60_train_int_%j.err
#SBATCH --hint=nomultithread
#SBATCH --distribution=block:block
#SBATCH --gres-flags=enforce-binding

# =============================================================================
# TRAINING SCRIPT - INTERNAL NORMALIZATION
# Purpose: Train model with tuned hyperparameters on smoothed AWAKEN data
# Usage: sbatch train_storm_smoothed_awaken_p60_internal.sh <model>
#        model: informer, autoformer, spacetimeformer
# Example: sbatch train_storm_smoothed_awaken_p60_internal.sh informer
# =============================================================================
...
# --- Print Job Info ---
echo "=============================================="
echo "TRAINING - INTERNAL NORMALIZATION"
echo "=============================================="
