...
#SBATCH --gres=gpu:4
#SBATCH --time=7-00:00
#SBATCH --job-name=tactis_tune_p1
#SBATCH --output=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/tactis_tune_p1_%j.out
#SBATCH --error=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/tactis_tune_p1_%j.err
#SBATCH --hint=nomultithread
#SBATCH --distribution=block:block
#SBATCH --gres-flags=enforce-binding

# =============================================================================
# TACTIS-2 PHASE 1 TUNING - FLOW/MARGINAL PATH
# Purpose: Phase 1 of two-stage TACTiS-2 tuning (skip_copula=True)
# Usage: sbatch tune_tactis_phase1_storm_smoothed_p60.sh [--restart_tuning]
# Example: sbatch tune_tactis_phase1_storm_smoothed_p60.sh
#          sbatch tune_tactis_phase1_storm_smoothed_p60.sh --restart_tuning
# =============================================================================
