...
#SBATCH --gres=gpu:4
#SBATCH --time=7-00:00
#SBATCH --job-name=smoothed60_tune_int
#SBATCH --output=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/smoothed60_tune_int_%j.out
#SBATCH --error=/dss/work/taed7566/Forecasting_Outputs/wind-forecasting/logs/slurm_logs/smoothed60_tune_int_%j.err
#SBATCH --hint=nomultithread
#SBATCH --distribution=block:block
#SBATCH --gres-flags=enforce-binding

# =============================================================================
# FULL TUNING SCRIPT - INTERNAL NORMALIZATION
# Purpose: Complete hyperparameter tuning with 25 epochs and 200 trials
# Usage: sbatch tune_storm_smoothed_awaken_p60_internal.sh <model> [--restart_tuning]
#        model: informer, autoformer, spacetimeformer
# Example: sbatch tune_storm_smoothed_awaken_p60_internal.sh informer
#          sbatch tune_storm_smoothed_awaken_p60_internal.sh autoformer --restart_tuning
# =============================================================================
...
# --- Print Job Info ---
echo "=============================================="
echo "FULL TUNING - INTERNAL NORMALIZATION"
echo "=============================================="
...
echo "=============================================="
echo "FULL TUNING COMPLETED - INTERNAL NORMALIZATION"
echo "Model: ${MODEL_NAME}"
