...
for i in $(seq 1 $SLURM_NTASKS); do
    srun --exclusive -n 1 python run_model.py --config $HOME/toolboxes/wind_forecasting_env/wind-forecasting/examples/inputs/training_inputs_kestrel.yaml --model $1 --mode tune &
done