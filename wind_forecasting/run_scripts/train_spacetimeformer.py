...
def create_dset(config, dataset_obj):
    ...
    # TODO handle multiple datasets by transforming csv_time_seris into a concatenated dataset
...
if __name__ == "__main__":
    ...
    # Dataset
    dataset = KPWindFarm(data_dir="/Users/ahenry/Documents/toolboxes/wind_forecasting/examples/data/normalized_data.parquet", 
