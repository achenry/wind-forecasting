...
def main():
    ...
    file_directory = "/Users/ahenry/OneDrive - Stanford/awaken_data"
    filenames = ["awaken_processed_smoothed_normalized_train_ready_15s_per_turbine_ctx80_pred4.parquet",
                 "awaken_processed_smoothed_normalized_train_ready_15s_per_turbine_ctx80_pred4_denormalize.parquet"]
