...
declare -a BATCH2=(matplotlib seaborn windrose plotly einops orjson filterpy) # added einops, orjson, filterpy
declare -a BATCH3=(optuna optuna-dashboard optuna-integration wandb notebook ipywidgets) # added notebook, ipywidgets
...
declare -a BATCH5_PIP=(memory-profiler performer_pytorch optuna-fast-fanova gunicorn)  # added performer_pytorch, optuna-fast-fanova, gunicorn
