...
URL = "https://github.com/achenry/wind_forecasting"
EMAIL = "ahenry@nrel.gov"
...
with open(ROOT / "wind_forecasting" / "version.py") as version_file:
...
setup(
    ...
    packages=["wind_forecasting"],  # find_packages(exclude=["tests", "*.tests", "*.tests.*", "tests.*"]),
